...
mset trill:password 123456 trill:gender 1 trill:fansnumber 0
...
# lset spider:urls 0 01_tmail.com
...
4.配置文件 - 配置 /ect/redis/redis.conf

```shell
(1).requirepass 密码
(2).bind 127.0.0.1 ::1 # 禁止远程链接
...
4.日期时间类型
# redis
1.字符串 - GET/SET/MGET/MSET/STRLEN/INCR/DECR/INCRBY/DECRBY/INCRBYFLOAT
2.列表 - LPUSH/RPUSH/LPOP/RPOP/BLPOP/BRPOP/LTRIM/LREM
3.哈希(散列)
4.集合
5.有序集合 -redis特有的数据类型
```
